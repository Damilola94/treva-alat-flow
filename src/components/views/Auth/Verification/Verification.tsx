    ...
    <div className="app_auth_login_container">
      ...
      <div className="app_auth_login_container__upper">
        <div className="app_auth_login !flex !flex-col !items-center text-center ">
          {verified ? (
            <Image src={SuccessImage} alt="Success" className="w-24 h-24 mx-auto mb-[20px]" unoptimized />
          ) : (
            <Image src={ErrorImage} alt="Error" className="w-24 h-24 mx-auto mb-[20px]" unoptimized />
          )}
