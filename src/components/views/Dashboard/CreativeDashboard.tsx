...
export default function Page() {
  ...
  const {setFieldValue, values, errors, handleChange, handleBlur, handleSubmit, touched, dirty, isValid} = formik;
  ...
  return (
    <div className="app_dashboard_page app_dashboard_home">
      ...
      <div className="app_dashboard_home__header">
        ...
        <div className="app_dashboard_home__kpis grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 app_dashboard_page__px">
          {kpis.map((item, index) => {
