import { BvnVerification } from '@/components/views';
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const pageUrl = `${fullHost}/client/dashboard/get-started/bvn-verification`;

  return {
    title: 'BVN Verification - Get Started | Geegs by Wema',
    description:
