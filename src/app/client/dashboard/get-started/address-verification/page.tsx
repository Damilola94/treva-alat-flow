import { AddressVerification } from '@/components/views';
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const pageUrl = `${fullHost}/client/dashboard/get-started/address-verification`;

  return {
    title: 'Address Verification - Get Started | Treva by Wema',
    description:
      'Start your journey on Treva. Set up your profile and explore features.',
    keywords: ['get started', 'dashboard', 'setup', 'Treva'],
    openGraph: {
      title: 'Address Verification  - Get Started | Treva',
