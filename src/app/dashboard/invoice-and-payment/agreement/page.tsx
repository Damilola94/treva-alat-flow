...
export default function Page () {
  ...
  //       router.push(routes.dashboard.invoiceAndPayment.review.path);
  //     } else {
            ...
            <div className="app_get_started_professional_details__form flex flex-col gap-10 !overflow-y-auto">
                <Modal {...{ open: isDecisionModalOpen, handleClose: handleCloseModal }}>
                    <div className="app_modal__ctt__mid">
                        <h2 className="app_modal__ctt__mid__h2">Are you sure you want to delete
                        agreement?</h2>
                      ...
                      ? (
                        <div className="flex items-center justify-between">
                            <div className="flex items-center">
                                <Image src="/icons/pdf-icon.svg" alt="PDF Icon" className="w-6 h-6 mr-3" />
                                <div>
                                    <p className="text-sm font-medium">{file}</p>
                                    <p className="text-xs text-gray-500">{(file / 1024 / 1024).toFixed(1)} MB</p>
                                </div>
                            </div>
                            <button
                      ...
                      : (
                        <label className="cursor-pointer hover:underline">
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <p className="text-xs text-gray-500">PDF, PNG, JPG, GIF | 10MB max.</p>
                            </div>
                        </label>
                        )}
                </div>
                ...
                <Button
                    ...
                    onClick={() => { router.push(routes.dashboard.invoiceAndPayment.review.path); }}
                >
                    Save & Continue
                </Button>
            </div>
